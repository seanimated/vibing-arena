...
function action_list(PDO $pdo): never
{
    ...
    $dataSql = "
        SELECT
            ...
            rt.submission_address_two,
            rt.submission_address_city,
            rt.submission_address_postal_code,
            rt.compulsory_briefing,
            rt.briefing_date,
            rt.briefing_venue,
            rt.briefing_address_one,
            rt.briefing_address_two,
            rt.briefing_address_city,
            rt.briefing_address_postal_code,
            rt.cidb_grade,
...
function action_update(PDO $pdo, array $body): never
{
    ...
    $allowed = [
        ...
        'submission_address_two' => 'string',
        'submission_address_city' => 'string',
        'submission_address_postal_code' => 'string',
        'briefing_date'        => 'string',
        'compulsory_briefing'  => 'int',
        'briefing_address_one' => 'string',
        'briefing_address_two' => 'string',
        'briefing_address_city' => 'string',
        'briefing_address_postal_code' => 'string',
        'cidb_grade'           => 'string',
...
//   ADD COLUMN IF NOT EXISTS submission_address_two         VARCHAR(500) DEFAULT NULL,
//   ADD COLUMN IF NOT EXISTS submission_address_city        VARCHAR(255) DEFAULT NULL,
//   ADD COLUMN IF NOT EXISTS submission_address_postal_code VARCHAR(20)  DEFAULT NULL,
//   ADD COLUMN IF NOT EXISTS briefing_address_one           VARCHAR(500) DEFAULT NULL,
//   ADD COLUMN IF NOT EXISTS briefing_address_two           VARCHAR(500) DEFAULT NULL,
//   ADD COLUMN IF NOT EXISTS briefing_address_city          VARCHAR(255) DEFAULT NULL,
//   ADD COLUMN IF NOT EXISTS briefing_address_postal_code   VARCHAR(20)  DEFAULT NULL,
...
function push_to_published(PDO $pdo, int $rawId, array $tender): void
{
    ...
    $p = [
        ...
        ':subaddr2'  => $r['submission_address_two']         ?? null,
        ':subcity'   => $r['submission_address_city']        ?? null,
        ':subpc'     => $r['submission_address_postal_code'] ?? null,
        ':braddr1'   => $r['briefing_address_one']         ?? null,
        ':braddr2'   => $r['briefing_address_two']         ?? null,
        ':brcity'    => $r['briefing_address_city']        ?? null,
        ':brpc'      => $r['briefing_address_postal_code'] ?? null,
    ...
    if ($existing) {
        $pdo->prepare("
            UPDATE published_tenders SET
                ...
                submission_address_two         = :subaddr2,
                submission_address_city        = :subcity,
                submission_address_postal_code = :subpc,
                briefing_address_one           = :braddr1,
                briefing_address_two           = :braddr2,
                briefing_address_city          = :brcity,
                briefing_address_postal_code   = :brpc,
        ...
        $pdo->prepare("
            ...
            VALUES
                (:rid, :title, :ref, :desc, :org,
                 ...
                 :subaddr2, :subcity, :subpc,
                 :braddr1, :braddr2, :brcity, :brpc,
